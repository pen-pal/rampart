...
import {
  Plus, Trash2, KeyRound, Copy, Check, AlertCircle, Loader2, X, Eye, EyeOff,
} from 'lucide-react';
  ...
  return (
    <div className="rampart">
      ...
      <div style={{ maxWidth: 880, margin: '0 auto', padding: '32px 32px 64px' }}>
        <SubViewHeader title={t('ingestkeys.title')} icon={KeyRound} />
...
function CreateModal({ onCancel, onCreated }) {
  ...
  return (
    <div className="modal-backdrop">
      <div ref={ref} role="dialog" aria-modal="true" aria-label={t('ingestkeys.new')} tabIndex={-1} className="modal">
...
function TokenModal({ issued, onClose }) {
  ...
  return (
    <div className="modal-backdrop">
      <div ref={ref} role="dialog" aria-modal="true" aria-label={t('ingestkeys.created_title')} tabIndex={-1} className="modal">
