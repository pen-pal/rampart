...
export const api = {
  ...
  traces: {
    ...
    operationTrend: (service, operation, hours) => request(`/v1/traces/operation-trend?service=${encodeURIComponent(service)}&operation=${encodeURIComponent(operation)}&hours=${hours || 24}`),
  },
