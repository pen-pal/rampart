...
### ✅ In Scope
The core feature set is shipped (38 probe kinds, 130 notification channels, status pages, folders, dependencies, maintenance, 2FA, audit log). What's still welcome:
...
8. **Counts:** Bump the "38 types" line in the wizard intro, the README badge + heading, and `docs/ARCHITECTURE.md`.
...
28 flows × 5 browser projects (Chromium, Firefox, WebKit + branded Chrome / Edge channels) = 140 cross-browser runs per CI push.
