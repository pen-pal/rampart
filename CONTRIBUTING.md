...
### ✅ In Scope
The core feature set is shipped (35 probe kinds, 130 notification channels, status pages, folders, dependencies, maintenance, 2FA, audit log). What's still welcome:
...
8. **Counts:** Bump the "35 types" line in the wizard intro, the README badge + heading, and `docs/ARCHITECTURE.md`.
