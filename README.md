...
**One Rust binary. One Postgres. 35 probe kinds. 130 notification channels.**<br/>
...
[![Probes](https://img.shields.io/badge/probes-35-brightgreen.svg)](#-35-probe-kinds)
...
| 📢 **Messaging / RPC** | gRPC `health.v1`, MQTT, Kafka (ApiVersions handshake), NATS, LDAP, AMQP, SNMP, RADIUS |
...
│       ├── rampart-checker               # probe runners (35 kinds)
